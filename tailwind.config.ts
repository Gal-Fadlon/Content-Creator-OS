  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Content type colors
        content: {
          reel: "hsl(var(--content-reel))",
          story: "hsl(var(--content-story))",
          post: "hsl(var(--content-post))",
        },
        // Event marker colors
        marker: {
          red: "hsl(var(--marker-red))",
          blue: "hsl(var(--marker-blue))",
          beige: "hsl(var(--marker-beige))",
          brown: "hsl(var(--marker-brown))",
          black: "hsl(var(--marker-black))",
        },
        header: {
